...
mkisofs -o ../../images/${iso_label}-custom.iso -b isolinux/isolinux.bin -c isolinux/boot.cat --joliet-long --no-emul-boot --boot-load-size 4 --boot-info-table -J -R -V  "${iso_label}" .

#isohybrid --uefi ../../images/${iso_label}-custom.iso
isohybrid ../../images/${iso_label}-custom.iso

implantisomd5 ../../images/${iso_label}-custom.iso
